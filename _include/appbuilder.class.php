...
class AppBuilder extends AbstractBuilder {
	 ...
	 * has no dependencies on any of the App class objects.  For these App classes, the build  
	 * process is essential a no-operation.  It simply returns the filename of the include copy.
	 *
	 * Note that this does not preclude the inclusion by a "##require" derective in a class processed 
	 * by the DefaultBuilder so there is no material runtime cost of doing this simplification.
	 *
